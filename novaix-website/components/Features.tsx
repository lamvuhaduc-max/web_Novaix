...
export default function Features() {
  return (
    <section id="giai-phap" className="py-[110px] relative z-[2] bg-bg-2">
      <div className="wrap">
        <div className="grid md:grid-cols-2 gap-[50px] items-center">
          ...
          <Reveal delay={0.15}>
            <div className="border border-line rounded-[20px] min-h-[340px] relative overflow-hidden grid place-items-center"
              style={{ background: "linear-gradient(160deg,#0b1120,#0d1424)" }}>
              <div className="relative w-[220px] h-[220px] rounded-full animate-spin18"
                style={{ border: "1px dashed rgba(45,212,191,0.4)" }}>
                <div className="absolute left-1/2 top-1/2 w-[380px] h-[380px] rounded-full -translate-x-1/2 -translate-y-1/2"
                ...
                {[
                  ...
                  <div key={i} className={`absolute w-[42px] h-[42px] rounded-[11px] grid place-items-center text-[18px] border border-line bg-[#0d1424] ${d.s}`}>
                    {d.e}
                  </div>
                ))}
              </div>
